...
<head>
    ...
    <div class="inbox">
        ...
        <label class="mail news Aurora_Times" for="m5">
            <div class="mail-title">Aurora Times 7/23/26</div>
            <div class="mail-sub">Aurora Times</div>
        </label>

        <label class="mail news Mushroom_Times" for="m6">
        ...
        <label class="mail news Cherry_Bomb" for="m11">
        ...
        <label class="mail promotional ARX_Industries" for="m15">
        ...
        <label class="mail trash bedrock_chronicle" for="m22">
        ...
        <label class="mail news Icy_News" for="m26">
        ...
        <label class="mail news Murkland_Times" for="m32">
        ...
        <label class="mail news Fatui" for="m34">
        ...
        <label class="mail news Cactus_News" for="m36">
        ...
        <label class="mail news Murkland_Times" for="m38">
        ...
        <label class="mail news Acorn" for="m40">
        ...
        <label class="mail news Great_Sylven" for="m45">
        ...
        <label class="mail updates Lucifela" for="m49">
        ...
        <label class="mail news Mushroom_Times" for="m53">
        ...
        <label class="mail updates JosBot" for="m66">
        ...
        <label class="mail news The_Slime_Times" for="m70">
            <div class="mail-title">The Slime Times No. 7</div>
            <div class="mail-sub">The Slime Times</div>
        </label>

        <label class="mail news Cactus_News" for="m71">
        ...
        <label class="mail news International_News_Network" for="m73">
        ...
        <label class="mail promotional Iron_Co_Company_Email" for="m78">
        ...
        <label class="mail news Great_Sylven" for="m80">
        ...
        <label class="mail news Mesa_Times" for="m88">
            <div class="mail-title">Mesa Times 5/23/2026</div>
            <div class="mail-sub">Mesa Times</div>
        </label>

        <label class="mail news Cactus_News" for="m89">
        ...
        <label class="mail news Mesa_Times" for="m92">
        ...
        <label class="mail news Glacial_Press" for="m95">
        ...
        <label class="mail news Slime_Times" for="m99">
            <div class="mail-title">Slime Times 5/21/2026</div>
            <div class="mail-sub">Slime Times</div>
        </label>

        <label class="mail news Murkland_Times" for="m100">
        ...
        <label class="mail news Glacial_Press" for="m105">
        ...
        <label class="mail news Slime_Times" for="m108">
        ...
        <label class="mail news Cherry_Bomb" for="m111">
        ...
        <label class="mail news Icy_News" for="m114">
            <div class="mail-title">Icy News 5/18/2026</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Cactus_News" for="m115">
            <div class="mail-title">Cactus News 5/18/2026</div>
            <div class="mail-sub">Cactus News</div>
        </label>

        <label class="mail news Fatui" for="m116">
        ...
        <label class="mail news Glacial_Press" for="m120">
        ...
        <label class="mail news Fatui" for="m128">
            <div class="mail-title">Fatui 5/14/26</div>
            <div class="mail-sub">Fatui</div>
        </label>

        <label class="mail news Mushroom_Times" for="m129">
            <div class="mail-title">Mushroom Times 5/13/2026</div>
            <div class="mail-sub">Mushroom Times</div>
        </label>

        <label class="mail news Icy_News" for="m130">
        ...
        <label class="mail news Cherry_Bomb" for="m134">

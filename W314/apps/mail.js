...
<head>
    ...
    <div class="inbox">
        ...
        <label class="mail promotional ARX_Industries" for="m2">
        ...
        <label class="mail news Acorn" for="m4">
        ...
        <label class="mail updates" for="m7">
        ...
        <label class="mail trash bedrock_chronicle" for="m9">
        ...
        <label class="mail spam Spam_Company" for="m16">
        ...
        <label class="mail news Murkland_Times" for="m19">
        ...
        <label class="mail news Fatui" for="m21">
        ...
        <label class="mail news Mesa_Times" for="m24">
        ...
        <label class="mail news Cactus_News" for="m33">
        ...
        <label class="mail updates Lucifela" for="m36">
        ...
        <label class="mail news Bedrock_Chronicle" for="m38">
        ...
        <label class="mail news Mushroom_Times" for="m40">
        ...
        <label class="mail news International_News_Network" for="m50">
        ...
        <label class="mail updates JosBot" for="m53">
        ...
        <label class="mail news The_Slime_Times" for="m57">
        ...
        <label class="mail news International_News_Network" for="m60">
        ...
        <label class="mail news Great_Sylven" for="m63">
        ...
        <label class="mail promotional Iron_Co_Company_Email" for="m65">
        ...
        <label class="mail news Great_Sylven" for="m67">
            <div class="mail-title">The Great Sylven W1</div>
            <div class="mail-sub">Great Sylven</div>
        </label>

        <label class="mail news Mesa_Times" for="m68">
        ...
        <label class="mail news Glacial_Press" for="m72">
            <div class="mail-title">Glacial Press No. 6</div>
            <div class="mail-sub">Glacial Press</div>
        </label>

        <label class="mail news Slime_Times" for="m73">
        ...
        <label class="mail news Cherry_Bomb" for="m76">
            <div class="mail-title">Cherry Bomb No. 7</div>
            <div class="mail-sub">Cherry Bomb</div>
        </label>

        <label class="mail news Murkland_Times" for="m77">
        ...
        <label class="mail news Murkland_Times" for="m80">
        ...
        <label class="mail news Glacial_Press" for="m91">
        ...
        <label class="mail news Glacial_Press" for="m93">
        ...
        <label class="mail news Cherry_Bomb" for="m97">
        ...
        <label class="mail news Icy_News" for="m100">
        ...
        <label class="mail news Fatui" for="m102">
            <div class="mail-title">Fatui 5/18/26</div>
            <div class="mail-sub">Fatui</div>
        </label>

        <label class="mail news Glacial_Press" for="m103">
        ...
        <label class="mail news Cactus_News" for="m108">
        ...
        <label class="mail news Icy_News" for="m110">
            <div class="mail-title">Icy News 5/16/2026</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Mushroom_Times" for="m111">
            <div class="mail-title">Mushroom Times 5/15/2026</div>
            <div class="mail-sub">Mushroom Times</div>
        </label>

        <label class="mail news Icy_News" for="m112">
        ...
        <label class="mail news Fatui" for="m114">
            <div class="mail-title">Fatui 5/14/26</div>
            <div class="mail-sub">Fatui</div>
        </label>

        <label class="mail news Mushroom_Times" for="m115">

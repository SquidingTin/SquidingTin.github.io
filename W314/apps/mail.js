...
<head>
    ...
    <div class="inbox">
        ...
        <label class="mail news Cherry_Bomb" for="m4">
        ...
        <label class="mail promotional ARX_Industries" for="m8">
        ...
        <label class="mail news Acorn" for="m10">
        ...
        <label class="mail updates" for="m13">
        ...
        <label class="mail trash bedrock_chronicle" for="m15">
        ...
        <label class="mail news Cactus_News" for="m17">
            <div class="mail-title">Cactus News 6/18/26</div>
            <div class="mail-sub">Cactus News</div>
        </label>

        <label class="mail news Murkland_Times" for="m18">
            <div class="mail-title">The Murkland Times Edition 9</div>
            <div class="mail-sub">Murkland Times</div>
        </label>

        <label class="mail news Icy_News" for="m19">
            <div class="mail-title">Icy News 6/17/2026</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Cherry_Bomb" for="m20">
        ...
        <label class="mail news Murkland_Times" for="m25">
        ...
        <label class="mail news Murkland_Times" for="m31">
        ...
        <label class="mail updates Lucifela" for="m42">
        ...
        <label class="mail news Bedrock_Chronicle" for="m44">
        ...
        <label class="mail news Mushroom_Times" for="m46">
        ...
        <label class="mail news Glacial_Press" for="m55">
        ...
        <label class="mail updates JosBot" for="m59">
        ...
        <label class="mail news International_News_Network" for="m62">
            <div class="mail-title">The International Volume 5</div>
            <div class="mail-sub">International News Network</div>
        </label>

        <label class="mail news The_Slime_Times" for="m63">
        ...
        <label class="mail promotional Iron_Co_Company_Email" for="m71">
            <div class="mail-title">Iron Co Update</div>
            <div class="mail-sub">Iron Co Company Email</div>
        </label>

        <label class="mail news International_News_Network" for="m72">
            <div class="mail-title">The International Volume 3</div>
            <div class="mail-sub">International News Network</div>
        </label>

        <label class="mail news Great_Sylven" for="m73">
        ...
        <label class="mail news Cactus_News" for="m75">
            <div class="mail-title">Cactus News 5/25/26</div>
            <div class="mail-sub">Cactus News</div>
        </label>

        <label class="mail news International_News_Network" for="m76">
        ...
        <label class="mail news Glacial_Press" for="m78">
            <div class="mail-title">Glacial Press No. 6</div>
            <div class="mail-sub">Glacial Press</div>
        </label>

        <label class="mail news Slime_Times" for="m79">
        ...
        <label class="mail news Cactus_News" for="m81">
        ...
        <label class="mail news Slime_Times" for="m85">
        ...
        <label class="mail news Cherry_Bomb" for="m90">
            <div class="mail-title">Cherry Bomb No. 6</div>
            <div class="mail-sub">Cherry Bomb</div>
        </label>

        <label class="mail news Slime_Times" for="m91">
        ...
        <label class="mail news Cherry_Bomb" for="m98">
        ...
        <label class="mail news Mesa_Times" for="m102">
        ...
        <label class="mail news Cherry_Bomb" for="m104">
        ...
        <label class="mail news Icy_News" for="m106">
        ...
        <label class="mail news Fatui" for="m108">
        ...
        <label class="mail news Cherry_Bomb" for="m110">
        ...
        <label class="mail news Fatui" for="m115">
        ...
        <label class="mail news Mushroom_Times" for="m117">
        ...
        <label class="mail news Mushroom_Times" for="m121">
        ...
        <label class="mail news Cherry_Bomb" for="m126">

...
<head>
    ...
    <div class="inbox">
        ...
        <label class="mail promotional ARX_Industries" for="m10">
        ...
        <label class="mail updates" for="m15">
        ...
        <label class="mail trash bedrock_chronicle" for="m17">
        ...
        <label class="mail news Icy_News" for="m21">
        ...
        <label class="mail news Acorn" for="m35">
        ...
        <label class="mail news Glacial_Press" for="m38">
        ...
        <label class="mail news Great_Sylven" for="m40">
        ...
        <label class="mail news Bedrock_Chronicle" for="m42">
        ...
        <label class="mail updates Lucifela" for="m44">
        ...
        <label class="mail news Mushroom_Times" for="m48">
        ...
        <label class="mail news Cactus_News" for="m54">
            <div class="mail-title">Cactus News 6/02/26</div>
            <div class="mail-sub">Cactus News</div>
        </label>

        <label class="mail news Murkland_Times" for="m55">
            <div class="mail-title">The Murkland Times Edition 5</div>
            <div class="mail-sub">Murkland Times</div>
        </label>

        <label class="mail news Cactus_News" for="m56">
            <div class="mail-title">Cactus News 6/1/2026</div>
            <div class="mail-sub">Cactus News</div>
        </label>

        <label class="mail news Glacial_Press" for="m57">
            <div class="mail-title">Glacial Press No. 7</div>
            <div class="mail-sub">Glacial Press</div>
        </label>

        <label class="mail news International_News_Network" for="m58">
        ...
        <label class="mail updates JosBot" for="m61">
        ...
        <label class="mail news The_Slime_Times" for="m65">
        ...
        <label class="mail news International_News_Network" for="m68">
        ...
        <label class="mail news Great_Sylven" for="m71">
            <div class="mail-title">The Great Sylven W2</div>
            <div class="mail-sub">Great Sylven</div>
        </label>

        <label class="mail news Bedrock_Chronicle" for="m72">
            <div class="mail-title">The Bedrock Chronicles 5/26/26</div>
            <div class="mail-sub">Bedrock Chronicle</div>
        </label>

        <label class="mail promotional Iron_Co_Company_Email" for="m73">
        ...
        <label class="mail news Great_Sylven" for="m75">
        ...
        <label class="mail news International_News_Network" for="m78">
        ...
        <label class="mail news Glacial_Press" for="m80">
            <div class="mail-title">Glacial Press No. 6</div>
            <div class="mail-sub">Glacial Press</div>
        </label>

        <label class="mail news Slime_Times" for="m81">
        ...
        <label class="mail news Cactus_News" for="m83">
            <div class="mail-title">Cactus News 5/23/26</div>
            <div class="mail-sub">Cactus News</div>
        </label>

        <label class="mail news Cherry_Bomb" for="m84">
        ...
        <label class="mail news Mesa_Times" for="m86">
            <div class="mail-title">Mesa Times 5/22/2026</div>
            <div class="mail-sub">Mesa Times</div>
        </label>

        <label class="mail news Slime_Times" for="m87">
        ...
        <label class="mail news Glacial_Press" for="m89">
        ...
        <label class="mail news Slime_Times" for="m93">
        ...
        <label class="mail news Cactus_News" for="m95">
        ...
        <label class="mail news Slime_Times" for="m97">
        ...
        <label class="mail news Glacial_Press" for="m99">
        ...
        <label class="mail news Slime_Times" for="m102">
        ...
        <label class="mail news Cherry_Bomb" for="m105">
        ...
        <label class="mail news Fatui" for="m110">
        ...
        <label class="mail news Cactus_News" for="m113">
        ...
        <label class="mail news Mushroom_Times" for="m119">
            <div class="mail-title">Mushroom Times 5/15/2026</div>
            <div class="mail-sub">Mushroom Times</div>
        </label>

        <label class="mail news Icy_News" for="m120">
        ...
        <label class="mail news Fatui" for="m122">
            <div class="mail-title">Fatui 5/14/26</div>
            <div class="mail-sub">Fatui</div>
        </label>

        <label class="mail news Mushroom_Times" for="m123">
        ...
        <label class="mail news Mushroom_Times" for="m125">
        ...
        <label class="mail news Cherry_Bomb" for="m128">

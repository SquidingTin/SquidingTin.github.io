...
<head>
    ...
    <div class="inbox">
        ...
        <label class="mail news Cherry_Bomb" for="m2">
        ...
        <label class="mail promotional ARX_Industries" for="m6">
        ...
        <label class="mail updates" for="m11">
        ...
        <label class="mail news Fatui" for="m25">
            <div class="mail-title">Fatui 6/14/26</div>
            <div class="mail-sub">Fatui</div>
        </label>

        <label class="mail news International_News_Network" for="m26">
        ...
        <label class="mail news Murkland_Times" for="m29">
        ...
        <label class="mail news Murkland_Times" for="m35">
            <div class="mail-title">The Murkland Times Edition 6</div>
            <div class="mail-sub">Murkland Times</div>
        </label>

        <label class="mail news Great_Sylven" for="m36">
        ...
        <label class="mail updates Lucifela" for="m40">
        ...
        <label class="mail news Mushroom_Times" for="m44">
        ...
        <label class="mail news Glacial_Press" for="m53">
        ...
        <label class="mail updates JosBot" for="m57">
        ...
        <label class="mail news The_Slime_Times" for="m61">
        ...
        <label class="mail promotional Iron_Co_Company_Email" for="m69">
        ...
        <label class="mail news Slime_Times" for="m77">
        ...
        <label class="mail news Cactus_News" for="m79">
        ...
        <label class="mail news Slime_Times" for="m83">
            <div class="mail-title">Slime Times 5/22/2026</div>
            <div class="mail-sub">Slime Times</div>
        </label>

        <label class="mail news Murkland_Times" for="m84">
        ...
        <label class="mail news Murkland_Times" for="m87">
            <div class="mail-title">The Murkland Times Edition 2</div>
            <div class="mail-sub">Murkland Times</div>
        </label>

        <label class="mail news Cherry_Bomb" for="m88">
        ...
        <label class="mail news Murkland_Times" for="m90">
        ...
        <label class="mail news Cherry_Bomb" for="m96">
        ...
        <label class="mail news Cherry_Bomb" for="m102">
        ...
        <label class="mail news Icy_News" for="m104">
        ...
        <label class="mail news Fatui" for="m106">
        ...
        <label class="mail news Glacial_Press" for="m110">
        ...
        <label class="mail news Icy_News" for="m117">
        ...
        <label class="mail news Cherry_Bomb" for="m124">

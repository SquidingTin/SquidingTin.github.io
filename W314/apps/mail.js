...
<head>
    ...
    <div class="inbox">
        ...
        <label class="mail promotional ARX_Industries" for="m4">
        ...
        <label class="mail trash bedrock_chronicle" for="m11">
        ...
        <label class="mail news Cactus_News" for="m13">
        ...
        <label class="mail news Icy_News" for="m15">
            <div class="mail-title">Icy News 6/17/2026</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Cherry_Bomb" for="m16">
        ...
        <label class="mail spam Spam_Company" for="m18">
        ...
        <label class="mail news Fatui" for="m23">
        ...
        <label class="mail updates Lucifela" for="m38">
        ...
        <label class="mail news Mushroom_Times" for="m42">
        ...
        <label class="mail updates JosBot" for="m55">
        ...
        <label class="mail news The_Slime_Times" for="m59">
        ...
        <label class="mail news Great_Sylven" for="m65">
        ...
        <label class="mail promotional Iron_Co_Company_Email" for="m67">
        ...
        <label class="mail news Glacial_Press" for="m74">
            <div class="mail-title">Glacial Press No. 6</div>
            <div class="mail-sub">Glacial Press</div>
        </label>

        <label class="mail news Slime_Times" for="m75">
        ...
        <label class="mail news Cherry_Bomb" for="m86">
        ...
        <label class="mail news Mushroom_Times" for="m113">
        ...
        <label class="mail news Cherry_Bomb" for="m122">

...
<head>
    ...
    #m132:checked ~ .viewer .m132 {
        display: block;
    }


    #m133:checked ~ .viewer .m133 {
        display: block;
    }


    #m134:checked ~ .viewer .m134 {
        display: block;
    }


    #m135:checked ~ .viewer .m135 {
        display: block;
    }


    #m136:checked ~ .viewer .m136 {
        display: block;
    }
    ...
    #m164:checked ~ .viewer .m164 {
        display: block;
    }


    #m165:checked ~ .viewer .m165 {
        display: block;
    }


    #m166:checked ~ .viewer .m166 {
        display: block;
    }


    #m167:checked ~ .viewer .m167 {
        display: block;
    }


    #m168:checked ~ .viewer .m168 {
        display: block;
    }
    ...
    <input type="radio" name="mail" id="m132">
    <input type="radio" name="mail" id="m133">
    ...
    <input type="radio" name="mail" id="m164">
    <input type="radio" name="mail" id="m165">
    <input type="radio" name="mail" id="m166">
    <input type="radio" name="mail" id="m167">
    <input type="radio" name="mail" id="m168">
    ...
    <div class="inbox">
        ...
        <label class="mail news Icy_News" for="m2">
            <div class="mail-title">Icy News 9/14/26</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Icy_News" for="m3">
            <div class="mail-title">Icy News 9/9/26</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Icy_News" for="m4">
            <div class="mail-title">Icy News 9/8/26</div>
            <div class="mail-sub">Icy News</div>
        </label>
        ...
        <label class="mail news The_Daily_Spruce" for="m7">
        ...
        <label class="mail news Icy_News" for="m10">
            <div class="mail-title">Icy News 8/22/26</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Slime_Times" for="m11">
        ...
        <label class="mail news The_Daily_Spruce" for="m16">
            <div class="mail-title">The Daily Spruce 8/17/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail news The_Daily_Spruce" for="m17">
            <div class="mail-title">The Daily Spruce 8/16/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail news The_Daily_Spruce" for="m18">
            <div class="mail-title">The Daily Spruce 8/15/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail news Slime_Times" for="m19">
            <div class="mail-title">Slime Times 8/06/2026</div>
            <div class="mail-sub">Slime Times</div>
        </label>

        <label class="mail news The_Daily_Spruce" for="m20">
        ...
        <label class="mail news Acorn" for="m27">
        ...
        <label class="mail news" for="m31">
            <div class="mail-title">News Roundup 7-8-26</div>
            <div class="mail-sub">Squid</div>
        </label>

        <label class="mail news The_Daily_Spruce" for="m32">
        ...
        <label class="mail news" for="m41">
            <div class="mail-title">News Roundup</div>
            <div class="mail-sub">Squid</div>
        </label>

        <label class="mail updates" for="m42">
        ...
        <label class="mail trash bedrock_chronicle" for="m44">
        ...
        <label class="mail news Fatui" for="m56">
            <div class="mail-title">Fatui 6/14/26</div>
            <div class="mail-sub">Fatui</div>
        </label>

        <label class="mail news International_News_Network" for="m57">
        ...
        <label class="mail news Mesa_Times" for="m59">
            <div class="mail-title">Mesa Times 6/12/2026</div>
            <div class="mail-sub">Mesa Times</div>
        </label>

        <label class="mail news The_Daily_Spruce" for="m60">
            <div class="mail-title">The Daily Spruce 6/12/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail news Murkland_Times" for="m61">
            <div class="mail-title">The Murkland Times Edition 7</div>
            <div class="mail-sub">Murkland Times</div>
        </label>

        <label class="mail news Mesa_Times" for="m62">
            <div class="mail-title">Mesa Times 6/11/2026</div>
            <div class="mail-sub">Mesa Times</div>
        </label>

        <label class="mail news Acorn" for="m63">
            <div class="mail-title">Acorn 6/11/26</div>
            <div class="mail-sub">Acorn</div>
        </label>

        <label class="mail news The_Daily_Spruce" for="m64">
            <div class="mail-title">The Daily Spruce 6/10/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail news Mesa_Times" for="m65">
        ...
        <label class="mail news Murkland_Times" for="m68">
            <div class="mail-title">The Murkland Times Edition 6</div>
            <div class="mail-sub">Murkland Times</div>
        </label>

        <label class="mail news Great_Sylven" for="m69">
        ...
        <label class="mail news The_Daily_Spruce" for="m73">
            <div class="mail-title">The Daily Spruce 6/6/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail updates Lucifela" for="m74">
        ...
        <label class="mail news The_Daily_Spruce" for="m77">
            <div class="mail-title">The Daily Spruce 6/5/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail news Mesa_Times" for="m78">
            <div class="mail-title">Mesa Times 6/5/2026</div>
            <div class="mail-sub">Mesa Times</div>
        </label>

        <label class="mail news Mushroom_Times" for="m79">
            <div class="mail-title">Mushroom Times 6/4/2026</div>
            <div class="mail-sub">Mushroom Times</div>
        </label>

        <label class="mail news Mesa_Times" for="m80">
            <div class="mail-title">Mesa Times 6/4/2026</div>
            <div class="mail-sub">Mesa Times</div>
        </label>

        <label class="mail news Bedrock_Chronicle" for="m81">
            <div class="mail-title">The Bedrock Chronicle 6/4/2026</div>
            <div class="mail-sub">Bedrock Chronicle</div>
        </label>

        <label class="mail news Mesa_Times" for="m82">
            <div class="mail-title">Mesa Times 6/3/2026</div>
            <div class="mail-sub">Mesa Times</div>
        </label>

        <label class="mail news Bedrock_Chronicle" for="m83">
        ...
        <label class="mail news Murkland_Times" for="m86">
            <div class="mail-title">The Murkland Times Edition 5</div>
            <div class="mail-sub">Murkland Times</div>
        </label>

        <label class="mail news Cactus_News" for="m87">
        ...
        <label class="mail news International_News_Network" for="m89">
            <div class="mail-title">The International Volume 6</div>
            <div class="mail-sub">International News Network</div>
        </label>

        <label class="mail news Bedrock_Chronicle" for="m90">
            <div class="mail-title">The Bedrock Chronicles 6/1/26</div>
            <div class="mail-sub">Bedrock Chronicle</div>
        </label>

        <label class="mail news Bedrock_Chronicle" for="m91">
            <div class="mail-title">The Bedrock Chronicles 5/31/26</div>
            <div class="mail-sub">Bedrock Chronicle</div>
        </label>

        <label class="mail updates JosBot" for="m92">
        ...
        <label class="mail news Bedrock_Chronicle" for="m94">
        ...
        <label class="mail news The_Slime_Times" for="m96">
            <div class="mail-title">The Slime Times No. 7</div>
            <div class="mail-sub">The Slime Times</div>
        </label>

        <label class="mail news Cactus_News" for="m97">
        ...
        <label class="mail news The_Daily_Spruce" for="m99">
            <div class="mail-title">The Daily Spruce 5/29/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail news International_News_Network" for="m100">
            <div class="mail-title">The International Volume 4</div>
            <div class="mail-sub">International News Network</div>
        </label>

        <label class="mail news Mesa_Times" for="m101">
            <div class="mail-title">Mesa Times 5/28/2026</div>
            <div class="mail-sub">Mesa Times</div>
        </label>

        <label class="mail news The_Daily_Spruce" for="m102">
            <div class="mail-title">The Daily Spruce 5/28/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail news Bedrock_Chronicle" for="m103">
            <div class="mail-title">The Bedrock Chronicles 5/28/26</div>
            <div class="mail-sub">Bedrock Chronicle</div>
        </label>

        <label class="mail news Great_Sylven" for="m104">
            <div class="mail-title">The Great Sylven W2</div>
            <div class="mail-sub">Great Sylven</div>
        </label>

        <label class="mail news Bedrock_Chronicle" for="m105">
            <div class="mail-title">The Bedrock Chronicles 5/26/26</div>
            <div class="mail-sub">Bedrock Chronicle</div>
        </label>

        <label class="mail promotional Iron_Co_Company_Email" for="m106">
            <div class="mail-title">Iron Co Update</div>
            <div class="mail-sub">Iron Co Company Email</div>
        </label>

        <label class="mail news International_News_Network" for="m107">
            <div class="mail-title">The International Volume 3</div>
            <div class="mail-sub">International News Network</div>
        </label>

        <label class="mail news Great_Sylven" for="m108">
            <div class="mail-title">The Great Sylven W1</div>
            <div class="mail-sub">Great Sylven</div>
        </label>

        <label class="mail news The_Daily_Spruce" for="m109">
            <div class="mail-title">The Daily Spruce 5/26/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail news Great_Sylven" for="m110">
            <div class="mail-title">The Great Sylven W1</div>
            <div class="mail-sub">Great Sylven</div>
        </label>

        <label class="mail news Mesa_Times" for="m111">
        ...
        <label class="mail news The_Daily_Spruce" for="m113">
            <div class="mail-title">The Daily Spruce 5/25/26</div>
            <div class="mail-sub">The Daily Spruce</div>
        </label>

        <label class="mail news International_News_Network" for="m114">
            <div class="mail-title">The International Volume 2</div>
            <div class="mail-sub">International News Network</div>
        </label>

        <label class="mail news International_News_Network" for="m115">
            <div class="mail-title">The International Volume 1</div>
            <div class="mail-sub">International News Network</div>
        </label>

        <label class="mail news Glacial_Press" for="m116">
            <div class="mail-title">Glacial Press No. 6</div>
            <div class="mail-sub">Glacial Press</div>
        </label>

        <label class="mail news Slime_Times" for="m117">
        ...
        <label class="mail news Glacial_Press" for="m139">
        ...
        <label class="mail news Glacial_Press" for="m141">
            <div class="mail-title">Glacial Press No. 3</div>
            <div class="mail-sub">Glacial Press</div>
        </label>

        <label class="mail news Slime_Times" for="m142">
            <div class="mail-title">Slime Times 5/19/2026</div>
            <div class="mail-sub">Slime Times</div>
        </label>

        <label class="mail news Cactus_News" for="m143">
            <div class="mail-title">Cactus News 5/19/2026</div>
            <div class="mail-sub">Cactus News</div>
        </label>

        <label class="mail news Mesa_Times" for="m144">
            <div class="mail-title">Mesa Times 5/19/2026</div>
            <div class="mail-sub">Mesa Times</div>
        </label>

        <label class="mail news Cherry_Bomb" for="m145">
            <div class="mail-title">Cherry Bomb No. 4</div>
            <div class="mail-sub">Cherry Bomb</div>
        </label>

        <label class="mail news Cherry_Bomb" for="m146">
            <div class="mail-title">Cherry Bomb No. 3</div>
            <div class="mail-sub">Cherry Bomb</div>
        </label>

        <label class="mail news Mesa_Times" for="m147">
            <div class="mail-title">Mesa Times 5/18/2026</div>
            <div class="mail-sub">Mesa Times</div>
        </label>

        <label class="mail news Icy_News" for="m148">
            <div class="mail-title">Icy News 5/18/2026</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Cactus_News" for="m149">
            <div class="mail-title">Cactus News 5/18/2026</div>
            <div class="mail-sub">Cactus News</div>
        </label>

        <label class="mail news Fatui" for="m150">
            <div class="mail-title">Fatui 5/18/26</div>
            <div class="mail-sub">Fatui</div>
        </label>

        <label class="mail news Glacial_Press" for="m151">
            <div class="mail-title">Glacial Press No. 2</div>
            <div class="mail-sub">Glacial Press</div>
        </label>

        <label class="mail news Cherry_Bomb" for="m152">
            <div class="mail-title">Cherry Bomb No. 2</div>
            <div class="mail-sub">Cherry Bomb</div>
        </label>

        <label class="mail news Cactus_News" for="m153">
            <div class="mail-title">Cactus News 5/17/2026</div>
            <div class="mail-sub">Cactus News</div>
        </label>

        <label class="mail news Glacial_Press" for="m154">
        ...
        <label class="mail news Cactus_News" for="m156">
        ...
        <label class="mail news Icy_News" for="m158">
            <div class="mail-title">Icy News 5/16/2026</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Mushroom_Times" for="m159">
            <div class="mail-title">Mushroom Times 5/15/2026</div>
            <div class="mail-sub">Mushroom Times</div>
        </label>

        <label class="mail news Icy_News" for="m160">
        ...
        <label class="mail news Fatui" for="m162">
            <div class="mail-title">Fatui 5/14/26</div>
            <div class="mail-sub">Fatui</div>
        </label>

        <label class="mail news Mushroom_Times" for="m163">
            <div class="mail-title">Mushroom Times 5/13/2026</div>
            <div class="mail-sub">Mushroom Times</div>
        </label>

        <label class="mail news Icy_News" for="m164">
            <div class="mail-title">Icy News 5/13/2026</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Mushroom_Times" for="m165">
            <div class="mail-title">Mushroom Times 5/12/2026</div>
            <div class="mail-sub">Mushroom Times</div>
        </label>

        <label class="mail news Icy_News" for="m166">
            <div class="mail-title">Icy News 5/12/2026</div>
            <div class="mail-sub">Icy News</div>
        </label>

        <label class="mail news Mushroom_Times" for="m167">
            <div class="mail-title">Mushroom Times 5/11/2025</div>
            <div class="mail-sub">Mushroom Times</div>
        </label>

        <label class="mail news Cherry_Bomb" for="m168">
    ...
    <div class="viewer">
        ...
        <div class="viewer-panel m2">
            <h2>Icy News 9/14/26</h2>

    
        <div class="mail-images top">
            <img src="images/news/Icy_News/9-14-26.png" style="width:33%; height:auto; object-fit:cover;">
        </div>

        <div class="mail-content">
            Icy News newspaper for 9/14/26 covers: The removal of Primal from all government positions, The reason why, and more.
        </div>

        </div>

        <div class="viewer-panel m3">
            <h2>Icy News 9/9/26</h2>

    
        <div class="mail-content">
            Icy News newspaper for 9/9/26 covers: Primal violated the Whistleblower act, New Alaska laws, and more.
        </div>

        <div class="mail-images bottom">
            <img src="images/news/Icy_News/9-9-26_1.png" style="width:33%; height:auto; object-fit:cover;">
        <img src="images/news/Icy_News/9-9-26_2.png" style="width:33%; height:auto; object-fit:cover;">
        </div>

        </div>

        <div class="viewer-panel m4">
            <h2>Icy News 9/8/26</h2>

    
        <div class="mail-content">
            Icy News newspaper for 9/8/26 covers: The Charter draft being accepted, and more.
        </div>

        <div class="mail-images bottom">
            <img src="images/news/Icy_News/9-8-26.png" style="width:33%; height:auto; object-fit:cover;">
        </div>
        ...
        <div class="mail-images bottom">
            <img src="images/news/Icy_News/9-4-26.png" style="width:33%; height:auto; object-fit:cover;">
        </div>
        ...
        <div class="mail-content">
            The Slime Times newspaper for 9/22/2026 covers: the football news team, Royal Marriage, The INSMP Wiki, Their rehiring of reporters, and more.
        </div>

        <div class="mail-images bottom">
            <img src="images/news/slimetimes/slimetimes_9-22-26_1.png" style="width:33%; height:auto; object-fit:cover;">
        <img src="images/news/slimetimes/slimetimes_9-22-26_2.png" style="width:33%; height:auto; object-fit:cover;">
        <img src="images/news/slimetimes/slimetimes_9-22-26_3.png" style="width:33%; height:auto; object-fit:cover;">
        <img src="images/news/slimetimes/slimetimes_9-22-26_4.png" style="width:33%; height:auto; object-fit:cover;">
        </div>
        ...
        <div class="mail-content">
            The Slime Times newspaper for 8/06/26 covers: The return of The Slime Times, A farewell to brick, and more.
        </div>

        <div class="mail-images bottom">
            <img src="images/news/slimetimes/slimetimes_8-06-26_1.png" style="width:33%; height:auto; object-fit:cover;">
        <img src="images/news/slimetimes/slimetimes_8-06-26_2.png" style="width:33%; height:auto; object-fit:cover;">
        </div>
        ...
        <div class="mail-images bottom">
            <img src="images/news/Sylven/Great_Sylven_W2.png" style="width:33%; height:auto; object-fit:cover;">
        </div>
        ...
        <div class="mail-images bottom">
            <img src="images/news/Sylven/Great_Sylven_W1.png" style="width:33%; height:auto; object-fit:cover;">
        </div>

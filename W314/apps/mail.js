...
<head>
    ...
    <div class="inbox">
        ...
        <label class="mail news Aurora_Times" for="m4">
            <div class="mail-title">Aurora Times 7/23/26</div>
            <div class="mail-sub">Aurora Times</div>
        </label>

        <label class="mail news Mushroom_Times" for="m5">
        ...
        <label class="mail news Cherry_Bomb" for="m10">
        ...
        <label class="mail promotional ARX_Industries" for="m14">
        ...
        <label class="mail news Acorn" for="m16">
        ...
        <label class="mail trash bedrock_chronicle" for="m21">
        ...
        <label class="mail updates" for="m27">
            <div class="mail-title">Important News Infomation</div>
            <div class="mail-sub">Squid</div>
        </label>

        <label class="mail spam Spam_Company" for="m28">
        ...
        <label class="mail news Fatui" for="m33">
        ...
        <label class="mail news Cactus_News" for="m35">
        ...
        <label class="mail news Murkland_Times" for="m43">
            <div class="mail-title">The Murkland Times Edition 6</div>
            <div class="mail-sub">Murkland Times</div>
        </label>

        <label class="mail news Great_Sylven" for="m44">
        ...
        <label class="mail updates Lucifela" for="m48">
        ...
        <label class="mail news Mushroom_Times" for="m52">
        ...
        <label class="mail news Murkland_Times" for="m59">
        ...
        <label class="mail updates JosBot" for="m65">
        ...
        <label class="mail news The_Slime_Times" for="m69">
        ...
        <label class="mail promotional Iron_Co_Company_Email" for="m77">
        ...
        <label class="mail news Great_Sylven" for="m79">
        ...
        <label class="mail news International_News_Network" for="m83">
        ...
        <label class="mail news Slime_Times" for="m86">
        ...
        <label class="mail news Cherry_Bomb" for="m89">
        ...
        <label class="mail news Slime_Times" for="m92">
        ...
        <label class="mail news Glacial_Press" for="m94">
        ...
        <label class="mail news Slime_Times" for="m107">
        ...
        <label class="mail news Mesa_Times" for="m109">
        ...
        <label class="mail news Cherry_Bomb" for="m117">
        ...
        <label class="mail news Fatui" for="m127">
        ...
        <label class="mail news Cherry_Bomb" for="m133">

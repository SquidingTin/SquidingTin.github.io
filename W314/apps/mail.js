...
<head>
    ...
    <div class="inbox">
        ...
        <label class="mail promotional ARX_Industries" for="m5">
        ...
        <label class="mail news Acorn" for="m7">
        ...
        <label class="mail trash bedrock_chronicle" for="m12">
        ...
        <label class="mail news Murkland_Times" for="m22">
        ...
        <label class="mail news Fatui" for="m24">
        ...
        <label class="mail news Mesa_Times" for="m27">
        ...
        <label class="mail news Glacial_Press" for="m33">
        ...
        <label class="mail updates Lucifela" for="m39">
        ...
        <label class="mail news Bedrock_Chronicle" for="m41">
        ...
        <label class="mail news Mushroom_Times" for="m43">
        ...
        <label class="mail news Murkland_Times" for="m50">
        ...
        <label class="mail news International_News_Network" for="m53">
        ...
        <label class="mail updates JosBot" for="m56">
        ...
        <label class="mail news The_Slime_Times" for="m60">
        ...
        <label class="mail promotional Iron_Co_Company_Email" for="m68">
        ...
        <label class="mail news Great_Sylven" for="m70">
        ...
        <label class="mail news Glacial_Press" for="m75">
            <div class="mail-title">Glacial Press No. 6</div>
            <div class="mail-sub">Glacial Press</div>
        </label>

        <label class="mail news Slime_Times" for="m76">
        ...
        <label class="mail news Glacial_Press" for="m84">
        ...
        <label class="mail news Icy_News" for="m103">
        ...
        <label class="mail news Fatui" for="m105">
        ...
        <label class="mail news Fatui" for="m112">
        ...
        <label class="mail news Mushroom_Times" for="m118">
        ...
        <label class="mail news Cherry_Bomb" for="m123">

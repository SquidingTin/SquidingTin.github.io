...
<head>
    ...
    <div class="inbox">
        ...
        <label class="mail news" for="m2">
            <div class="mail-title">NEW MAP</div>
            <div class="mail-sub">Squid</div>
        </label>
    ...
    <div class="viewer">
        ...
        <div class="viewer-panel m2">
            ...
            <div class="mail-content">
                The new version of the SMP map has been released.
            </div>
        </div>

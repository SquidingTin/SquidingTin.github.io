...
<head>
    ...
    <div class="inbox">
        ...
        <label class="mail news Fatui" for="m9">
            <div class="mail-title">Fatui 6/14/26</div>
            <div class="mail-sub">Fatui</div>
        </label>

        <label class="mail news International_News_Network" for="m10">
        ...
        <label class="mail news Glacial_Press" for="m17">
            <div class="mail-title">Glacial Press No. 8</div>
            <div class="mail-sub">Glacial Press</div>
        </label>

        <label class="mail news Great_Sylven" for="m18">
        ...
        <label class="mail updates Lucifela" for="m22">
        ...
        <label class="mail news Mushroom_Times" for="m26">
        ...
        <label class="mail updates JosBot" for="m38">
        ...
        <label class="mail news The_Slime_Times" for="m42">
        ...
        <label class="mail news Great_Sylven" for="m48">
        ...
        <label class="mail promotional Iron_Co_Company_Email" for="m50">
        ...
        <label class="mail news Great_Sylven" for="m52">
        ...
        <label class="mail news Slime_Times" for="m58">
        ...
        <label class="mail news Slime_Times" for="m63">
        ...
        <label class="mail news Icy_News" for="m81">
        ...
        <label class="mail news Fatui" for="m83">
        ...
        <label class="mail news Icy_News" for="m88">
        ...
        <label class="mail news Mushroom_Times" for="m92">
            <div class="mail-title">Mushroom Times 5/15/2026</div>
            <div class="mail-sub">Mushroom Times</div>
        </label>

        <label class="mail news Icy_News" for="m93">
        ...
        <label class="mail news Fatui" for="m95">
            <div class="mail-title">Fatui 5/14/26</div>
            <div class="mail-sub">Fatui</div>
        </label>

        <label class="mail news Mushroom_Times" for="m96">
        ...
        <label class="mail news Mushroom_Times" for="m98">
        ...
        <label class="mail news Mushroom_Times" for="m100">

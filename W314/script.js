...
<div class="inbox">
    ...
    <label class="mail updates Lucifela" for="m6">
    ...
    <label class="mail news Mushroom_Times" for="m9">
    ...
    <label class="mail news Cactus_News_Networks" for="m14">
        <div class="mail-title">Cactus News Networks 6/1/2026</div>
        <div class="mail-sub">Cactus News Networks</div>
    </label>

    <label class="mail news Glacial_Press" for="m15">
        <div class="mail-title">Glacial Press No. 7</div>
        <div class="mail-sub">Glacial Press</div>
    </label>

    <label class="mail news International_News_Network" for="m16">
    ...
    <label class="mail updates JosBot" for="m19">
    ...
    <label class="mail news The_Slimery_Times" for="m22">
    ...
    <label class="mail news Mesa_Times" for="m25">
    ...
    <label class="mail promotional Iron_Co_Company_Email" for="m29">
    ...
    <label class="mail news Glacial_Press" for="m35">
        <div class="mail-title">Glacial Press No. 6</div>
        <div class="mail-sub">Glacial Press</div>
    </label>

    <label class="mail news Slimery_Times" for="m36">
    ...
    <label class="mail news Cherry_Bomb" for="m38">
    ...
    <label class="mail news Glacial_Press" for="m50">

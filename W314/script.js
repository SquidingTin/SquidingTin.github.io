...
<div class="inbox">
    ...
    <label class="mail updates JosBot" for="m12">
    ...
    <label class="mail news The_Slimery_Times" for="m15">
    ...
    <label class="mail news Weekly_Sylven" for="m20">
    ...
    <label class="mail promotional Iron_Co_Company_Email" for="m22">

...
<div class="inbox">
    ...
    <label class="mail news Cactus_News_Networks" for="m2">
    ...
    <label class="mail updates Lucifela" for="m4">
    ...
    <label class="mail news Cactus_News_Networks" for="m11">
    ...
    <label class="mail updates JosBot" for="m16">
    ...
    <label class="mail news The_Slimery_Times" for="m19">
    ...
    <label class="mail news Weekly_Sylven" for="m24">
    ...
    <label class="mail promotional Iron_Co_Company_Email" for="m26">
    ...
    <label class="mail news Weekly_Sylven" for="m28">
    ...
    <label class="mail news Cherry_Bomb" for="m34">
...
<div class="viewer">
    ...
    <div class="viewer-panel m24">
        ...
        <div class="mail-content">
            The Weekly Sylven newspaper for 5/27/26 reports a major event, causing them to break their weekly standard.
        </div>
    </div>
    ...
    <div class="viewer-panel m28">
        ...
        <div class="mail-content">
            The Weekly Sylven newspaper for 5/26/26s: the rumbling heard near the Emerald Basin.
        </div>
    </div>

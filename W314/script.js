...
<div class="inbox">
    ...
    <label class="mail news Great_Sylven" for="m2">
        <div class="mail-title">The Great Sylven W3</div>
        <div class="mail-sub">Great Sylven</div>
    </label>

    <label class="mail news Cactus_News_Networks" for="m3">
    ...
    <label class="mail updates Lucifela" for="m5">
    ...
    <label class="mail news Cactus_News_Networks" for="m12">
    ...
    <label class="mail updates JosBot" for="m17">
    ...
    <label class="mail news The_Slimery_Times" for="m20">
    ...
    <label class="mail news Great_Sylven" for="m25">
    ...
    <label class="mail promotional Iron_Co_Company_Email" for="m27">
    ...
    <label class="mail news Cherry_Bomb" for="m35">
    ...
    <label class="mail news Cherry_Bomb" for="m41">

...
#sub-Slimery_Times:checked ~ .inbox .mail:not(.Slimery_Times) {
    display: none;
}
...
<div class="inbox">
    <label class="mail updates Squid" for="m1">
    ...
    <label class="mail news Cactus_News_Networks" for="m15">
        <div class="mail-title">Cactus News Networks 6/1/2026</div>
        <div class="mail-sub">Cactus News Networks</div>
    </label>

    <label class="mail news Glacial_Press" for="m16">
    ...
    <label class="mail news Bedrock_Chronicle" for="m27">
        <div class="mail-title">The Bedrock Chronicles 5/28/26</div>
        <div class="mail-sub">Bedrock Chronicle</div>
    </label>

    <label class="mail news Great_Sylven" for="m28">
    ...
    <label class="mail promotional Iron_Co_Company_Email" for="m30">
    ...
    <label class="mail news Great_Sylven" for="m32">
    ...
    <label class="mail news International_News_Network" for="m34">
        <div class="mail-title">The International Volume 2</div>
        <div class="mail-sub">International News Network</div>
    </label>

    <label class="mail news International_News_Network" for="m35">
        <div class="mail-title">The International Volume 1</div>
        <div class="mail-sub">International News Network</div>
    </label>

    <label class="mail news Glacial_Press" for="m36">
        <div class="mail-title">Glacial Press No. 6</div>
        <div class="mail-sub">Glacial Press</div>
    </label>

    <label class="mail news Slimery_Times" for="m37">
        <div class="mail-title">Slimery Times 5/23/2026</div>
        <div class="mail-sub">Slimery Times</div>
    </label>
    ...
    <label class="mail news Cherry_Bomb" for="m39">
    ...
    <label class="mail news Slimery_Times" for="m41">
        <div class="mail-title">Slimery Times 5/22/2026</div>
        <div class="mail-sub">Slimery Times</div>
    </label>

    <label class="mail news Glacial_Press" for="m42">
        <div class="mail-title">Glacial Press No. 5</div>
        <div class="mail-sub">Glacial Press</div>
    </label>

    <label class="mail news Cherry_Bomb" for="m43">
        <div class="mail-title">The Daily Cherry Bomb No. 6</div>
        <div class="mail-sub">Cherry Bomb</div>
    </label>

    <label class="mail news Slimery_Times" for="m44">
        <div class="mail-title">Slimery Times 5/21/2026</div>
        <div class="mail-sub">Slimery Times</div>
    </label>
    ...
    <label class="mail news Slimery_Times" for="m47">
        <div class="mail-title">Slimery Times 5/20/2026</div>
        <div class="mail-sub">Slimery Times</div>
    </label>
    ...
    <label class="mail news Glacial_Press" for="m49">
        <div class="mail-title">Glacial Press No. 4</div>
        <div class="mail-sub">Glacial Press</div>
    </label>

    <label class="mail news Cherry_Bomb" for="m50">
        <div class="mail-title">The Daily Cherry Bomb No. 5</div>
        <div class="mail-sub">Cherry Bomb</div>
    </label>

    <label class="mail news Glacial_Press" for="m51">
        <div class="mail-title">Glacial Press No. 3</div>
        <div class="mail-sub">Glacial Press</div>
    </label>

    <label class="mail news Slimery_Times" for="m52">
        <div class="mail-title">Slimery Times 5/19/2026</div>
        <div class="mail-sub">Slimery Times</div>
    </label>
    ...
    <label class="mail news Cherry_Bomb" for="m55">
        <div class="mail-title">The Daily Cherry Bomb No. 4</div>
        <div class="mail-sub">Cherry Bomb</div>
    </label>

    <label class="mail news Cherry_Bomb" for="m56">
    ...
    <label class="mail trash Icy_News" for="m58">
    ...
    <label class="mail news Cherry_Bomb" for="m61">
    ...
    <label class="mail trash Icy_News" for="m64">
    ...
    <label class="mail trash Icy_News" for="m66">
        <div class="mail-title">Icy News 5/16/2026</div>
        <div class="mail-sub">Icy News</div>
    </label>

    <label class="mail news Mushroom_Times" for="m67">
    ...
    <label class="mail trash Icy_News" for="m69">
        <div class="mail-title">Icy News 5/14/2026</div>
        <div class="mail-sub">Icy News</div>
    </label>

    <label class="mail news Mushroom_Times" for="m70">
        <div class="mail-title">Mushroom Times 5/13/2026</div>
        <div class="mail-sub">Mushroom Times</div>
    </label>

    <label class="mail trash Icy_News" for="m71">
        <div class="mail-title">Icy News 5/13/2026</div>
        <div class="mail-sub">Icy News</div>
    </label>

    <label class="mail news Mushroom_Times" for="m72">
        <div class="mail-title">Mushroom Times 5/12/2026</div>
        <div class="mail-sub">Mushroom Times</div>
    </label>

    <label class="mail trash Icy_News" for="m73">
    ...
    <label class="mail news Cherry_Bomb" for="m75">
...
<div class="viewer">
    ...
    <div class="viewer-panel m1">
        ...
        <div class="mail-content">
            Hello, and welcome to the OverNet.<br>I am Squid, I am a resident of Rakau nation and this is my personal project for the Daily Emerald SMP and its news. This project is meant to look like Windows 95 though not a 1-1 recreation.<br><br>If you have a suggestion, find a bug, or anything else, my contact is squid6245 on discord, <br>or just ping the user with <a href="3.14">W</a> in their name.
        </div>
    </div>
    ...
    <img src="images/news/slimetimes/5-23-26_4.png" style="width:33%; height:auto; object-fit:cover;">
        ...
        <div class="mail-content">
            The Slimery Times newspaper for 5/23/2026 covers: Ratifying their constituion happens today, An interview with Bonanza, and much more.
        </div>
    </div>
    ...
    <div class="viewer-panel m39">
        ...
        <div class="mail-content">
            The Daily Cherry Bomb newspaper for 5/22/26 covers: The Green Cross.
        </div>
    </div>
    ...
    <img src="images/news/slimetimes/5-22-26_3.png" style="width:33%; height:auto; object-fit:cover;">
        ...
        <div class="mail-content">
            The Slimery Times newspaper for 5/22/2026 covers: Ancient Discoveries, The final 3, and more.
        </div>
    </div>
    ...
    <div class="viewer-panel m43">
        ...
        <div class="mail-content">
            The Daily Cherry Bomb newspaper for 5/21/26 covers: The Blue Cross.
        </div>
    </div>

    <div class="viewer-panel m44">
        <h2>Slimery Times 5-21-2026</h2>
        ...
        <div class="mail-content">
            The Slimery Times newspaper for 5/21/2026 covers: Doctrine being postponed, Recognised towns, and more.
        </div>
    </div>
    ...
    <div class="viewer-panel m47">
        ...
        <div class="mail-content">
            The Slimery Times newspaper for 5/20/2026 covers: The landslide victor for the leader of the swamp, Burger Mans apology, and more.
        </div>
    </div>
    ...
    <div class="viewer-panel m50">
        ...
        <div class="mail-content">
            The Daily Cherry Bomb newspaper for 5/19/26 covers: The alliance forged with the Taiga biome.
        </div>
    </div>
    ...
    <div class="viewer-panel m52">
        ...
        <div class="mail-content">
            The Slimery Times newspaper for 5/19/2026 covers: The reasons to visit the swamp, their hopes for the nation, and more.
        </div>
    </div>
    ...
    <div class="viewer-panel m55">
        ...
        <div class="mail-content">
            The Daily Cherry Bomb newspaper for 5/19/26 covers: the ownership transfer to The Daily Emeralds team.
        </div>
    </div>
    ...
    <div class="viewer-panel m56">
        ...
        <div class="mail-content">
            The Daily Cherry Bomb newspaper for 5/18/26 covers: The upcoming elections.
        </div>
    </div>
    ...
    <div class="viewer-panel m61">
        ...
        <div class="mail-content">
            The Daily Cherry Bomb newspaper newspaper for 5/17/26 covers: The Constitution.
        </div>
    </div>
    ...
    <div class="viewer-panel m75">
        ...
        <div class="mail-content">
            The Daily Cherry Bomb newspaper newspaper for 5/05/26 covers: The Cherry Schism.
        </div>
    </div>
</div>
